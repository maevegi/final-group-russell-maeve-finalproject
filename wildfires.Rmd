...
ggplot(megatable, aes(year, total_acres_burned)) +
  ...
  scale_y_continuous("Total Acres BUrned", sec.axis = sec_axis(~ (. -a)/b, name = "Avg_Temp")) +
  ggtitle("Total Acres Burned & Average Temperature between 2009 and 2023") +
...
ggplot(megatable, aes(year, total_acres_burned)) +
  ...
  ggtitle("Total Acres Burned and Average Precipitation between 2009 and 2023")
```
...
ggplot(megatable, aes(year, Avg_Temp)) +
  ...
  scale_y_continuous("Avg_Temp", sec.axis = sec_axis(~ (.-e)/f, name = "Avg_Precipitation")) +
  ggtitle("Average Temperature and Precipitation between 2009 and 2023")
```

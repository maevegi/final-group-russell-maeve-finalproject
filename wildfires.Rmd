...
temp<-read_csv("https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/statewide/time-series/4/tavg/12/12/1969-2023.csv?base_prd=true&begbaseyear=1901&endbaseyear=2000",
               skip=4)
new_temp<-temp|>
...
```
```{r}
precipitation<- read_csv("https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance/statewide/time-series/4/pcp/12/12/1969-2023.csv?base_prd=true&begbaseyear=1901&endbaseyear=2000",
                         skip=4)

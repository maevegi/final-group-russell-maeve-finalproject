...
This graph highlights total acres burned and annual precipitation values
```{r}
...
This graph highlights average annual temperatures and annual precipitation values. Values for 2023 are missing since the year has not ended and the data has not been finalized. 
```{r}
